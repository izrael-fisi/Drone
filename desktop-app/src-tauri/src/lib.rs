...
use commands::{
    ...
    edge_api::{
        edge_api_device, edge_api_health, edge_api_mavlink_heartbeat, edge_api_mavlink_position,
    ...
    satellite::{
        download_map_region, download_tiles, estimate_map_usage, estimate_tiles,
        list_map_providers, survey_map_coverage,
    },
    ssh::{
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            edge_api_mission_planner_launch,
            test_ssh_connection,
            ssh_run_command,
            ssh_upload_files,
