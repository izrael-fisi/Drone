...
def summarize_workflow_validation(validation: dict[str, Any]) -> dict[str, Any]:
    ...
    for check in validation.get("checks") or []:
        ...
        if check.get("name") == "required_step_results":
            ...
            if superseded_steps:
                item["superseded_steps"] = superseded_steps
    ...
    return {
        ...
        "missing_required_step_count": validation.get("missing_required_step_count"),
        "active_required_step_count": validation.get("active_required_step_count"),
        "downstream_blocked_step_count": validation.get("downstream_blocked_step_count"),
        "superseded_step_count": validation.get("superseded_step_count"),
        "issues": issues,
